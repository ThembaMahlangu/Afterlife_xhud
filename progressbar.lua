...
RegisterNetEvent('Afterlife_xhud:client:ToggleBusyness', function(bool)
    isDoingAction = bool
end)

RegisterNetEvent('Afterlife_xhud:client:progress', function(action, finish)
    StartProgress(action, nil, nil, finish)
end)

RegisterNetEvent('Afterlife_xhud:client:ProgressWithStartEvent', function(action, start, finish)
    StartProgress(action, start, nil, finish)
end)

RegisterNetEvent('Afterlife_xhud:client:ProgressWithTickEvent', function(action, tick, finish)
    StartProgress(action, nil, tick, finish)
end)

RegisterNetEvent('Afterlife_xhud:client:ProgressWithStartAndTick', function(action, start, tick, finish)
    StartProgress(action, start, tick, finish)
end)

RegisterNetEvent('Afterlife_xhud:client:cancel', function()
    ActionCleanup()
    NuiMessage('cancel', {})
end)
